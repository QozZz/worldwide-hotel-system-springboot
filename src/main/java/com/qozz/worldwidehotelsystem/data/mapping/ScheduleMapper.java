...
public interface ScheduleMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "roomDto.hotelDto.description", source = "room.hotel.description"),
            @Mapping(target = "roomDto.hotelDto.hasPool", source = "room.hotel.hasPool"),
            @Mapping(target = "roomDto.hotelDto.hasRestaurant", source = "room.hotel.hasRestaurant"),
