...
public interface RoomMapper {
    @Mappings({
            ...
            @Mapping(target = "hotelDto.description", source = "room.hotel.description"),
            @Mapping(target = "hotelDto.hasPool", source = "room.hotel.hasPool"),
            @Mapping(target = "hotelDto.hasRestaurant", source = "room.hotel.hasRestaurant"),
